...
initial_position[height/2,length/2-1] = 2
initial_position[height/2,length/2] = 1
initial_position[height/2+1,length/2-1] = 1 
initial_position[height/2+1,length/2] = 2
	...
	def legit_move(x,y):
		...
		while dx <= 1:
			...
			while dy <= 1:
				...
				dy += 1
			dx += 1
		# return any(legit_helper(x-1,y-1,-1,-1,True), legit_helper(x-1,y,-1,0,True), legit_helper(x-1,y+1,-1,1,True),legit_helper(x,y-1,0,-1,True) \
		# 	legit_helper(x,y+1,0,1,True), legit_helper(x+1,y-1,1,-1,True), legit_helper(x+1,y,-1,0,True), legit_helper(x+1,y+1,1,1,True))
